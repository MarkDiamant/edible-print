...
export async function commerce(action,payload={}){
  const res=await fetch(COMMERCE_URL,{method:'POST',headers:{'content-type':'application/json','apikey':SUPABASE_PUBLISHABLE_KEY},body:JSON.stringify({action,...payload})});
