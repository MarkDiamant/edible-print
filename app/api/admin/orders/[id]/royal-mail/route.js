...
function serviceCode(choice){
  return choice==='express'?(clean(process.env.ROYAL_MAIL_EXPRESS_SERVICE_CODE)||'OLP1'):(clean(process.env.ROYAL_MAIL_STANDARD_SERVICE_CODE)||'OLP2');
}
...
function createWasAccepted(result,orderRef){
  // Click & Drop's create endpoint can return HTTP 200 with an empty/minimal body. Production fix v2.
