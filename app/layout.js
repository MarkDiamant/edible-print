...
export const metadata={title:'Edible Print | Custom Edible Icing Prints',description:'Custom edible icing prints for cakes, cupcakes, biscuits and branded treats. Fast UK dispatch.',icons:{icon:favicon,shortcut:favicon,apple:favicon}};
